...
export base=${base:-/igm/home/alp020/SVMatch/Gnomad/gnomad_SVSites_Hg38_barebones.vcf.gz}
...
if [ $help = true ]
  ...
  $RPath /igm/home/alp020/SVMatch/Scripts/REF_ALT_fixer.R ${location}
  ...
  bash /igm/home/alp020/SVMatch/Scripts/extractor.sh ${output}
