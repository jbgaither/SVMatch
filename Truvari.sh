...
svfile=${svfile:-null}
base=${base:-/igm/home/alp020/Spring2023/liftGnomad/gnomad_SVSites_Hg38_barebones.vcf.gz}
reference=${reference:-/igm/apps/genomes/Homo_sapiens/GRCh38/no_alt/GRCh38.fa}
output=${output:-./Truvari_out}
pctsim=${pctsim:-0.7}
pctsize=${pctsize:-0.7}
pctovl=${pctovl:-0.7}
refdist=${refdist:-500}
...
sizemin=${sizemin:-50}
sizefilt=${sizefilt:-30}
sizemax=${sizemax:-25000000000}
giabreport=${giabreport:-false}
debug=${debug:-false}
prog=${prog:-false}
unroll=${unroll:-false}
minhaplen=${minhaplen:-50}
typeignore=${typeignore:-false}
duptoins=${duptoins:-false}
uselev=${uselev:-false}
gtcomp=${gtcomp:-false}
bSample=${bSample:-false}
cSample=${cSample:-false}
passonly=${passonly:-false}
noref=${noref:-false}
includebed=${includebed:-false}
extend=${extend:-0}
help=${help:-false}
keepfinalvcf=${keepfinalvcf:-false}
...
if [ $help = true ]
  ...
  Rscript /igm/home/alp020/Spring2023/SV/Truvari/REF_ALT_fixer.R ${location}
